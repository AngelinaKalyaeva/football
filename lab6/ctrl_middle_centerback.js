const CTRL_MIDDLE_CENTERBACK = {
    ...
    rotateCenter(takenState) { // Повернуться к центру
        if(takenState.flags === undefined || takenState.flags["fprc"] === undefined) {
            return {n: "turn", v: 60};
        }

        this.action = "seekBall";
        return {n: "turn", v: takenState.flags["fprc"].angle}
    },
...
module.exports = CTRL_MIDDLE_CENTERBACK;